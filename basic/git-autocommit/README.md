An Ansible role that configures autocommit for Git
...
* The job only checks for the presence of @.git@ directories in @/@ and @/root/@
* Running the "Add default excludes" task on the edited @/root/config.git/info/exclude@ file may cause unexpected results
