An Ansible role that makes initial configuration for SSH user
...
| ---      | ---      | ---      |
| **users_create_per_user_group** | Creating a group with the same username as the user | true |
| **users_group** | Primary group (if users_create_per_user_group is not set)| users |
| **users_default_shell** | Default shell | /bin/bash |
| **users_create_homedirs** | Creating home directories | true |
